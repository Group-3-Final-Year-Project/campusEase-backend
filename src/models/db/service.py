...
class Service(Base):
    ...
    gallery: SQLAlchemyMapped[json.JSONEncoder] = sqlalchemy_mapped_column(sqlalchemy.JSON)
    prices: SQLAlchemyMapped[json.JSONEncoder] = sqlalchemy_mapped_column(sqlalchemy.JSON)
